...
class RecipeViewSet(viewsets.ModelViewSet, FavoriteActionsMixin, ShoppingCartActionsMixin):
    ...
    def create(self, request, *args, **kwargs):
        ...
        output_serializer = RecipeSerializer(serializer.instance, context = {'request': request})
