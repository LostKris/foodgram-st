...
from shopping_cart.shopping_cart_manage import add_to_shopping_list, remove_from_shopping_list, get_shopping_cart_data
import json
...
class ShoppingCartActionsMixin:
    ...
    def get_shopping_cart_file(self, request):
        ...
        str_data = (
                ['Ингредиент,единица измерения,количество']
